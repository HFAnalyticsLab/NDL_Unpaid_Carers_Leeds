...
a2_out_int_gp$T2_5_age_band_gender_gp
...
a2_out_demo_gp$T2_2_age_band_gp
...
# a2_out_demo_gp_plots$T2_2_age_band_gp
a2_out_int_gp$T2_6_age_band_imd_decile_gp
...
a2_out_int_gp_plots <- 
  ...
  map(.x = ., 
      .f = ~ pivot_longer(data = ., 
        ...
        facet_grid(metric~.data[[names(.x)[3]]], scales = "free") +  
        theme_bw() +
        theme(legend.position = "top")
  ) %>% 
...
a2_out_int_gp_plots$T2_6_age_band_imd_decile_gp
a2_out_int_gp_plots$T2_7_gender_imd_decile_gp
